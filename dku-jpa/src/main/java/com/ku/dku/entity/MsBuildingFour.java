...
/**
 * MsBuildingFour generated by hbm2java
 */
@Entity
@Table(name="ms_building_four"
    //, catalog="dku"
)
public class MsBuildingFour  implements java.io.Serializable, BaseEntity {
    ...
    public MsBuildingFour() {
    }


    public MsBuildingFour(Long roomId, Long floorId, Long buildingId, Integer number, Integer buildingTotal, Long typeId) {
        this.roomId = roomId;
