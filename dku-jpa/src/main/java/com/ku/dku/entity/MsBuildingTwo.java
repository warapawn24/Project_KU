...
/**
 * MsBuildingTwo generated by hbm2java
 */
@Entity
@Table(name="ms_building_two"
    //, catalog="dku"
)
public class MsBuildingTwo  implements java.io.Serializable, BaseEntity {
    ...
    public MsBuildingTwo() {
    }


    public MsBuildingTwo(Long roomId, Long floorId, Long buildingId, Integer number, Integer buildingTotal, Long typeId) {
        this.roomId = roomId;
